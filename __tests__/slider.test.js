...
describe('Slider Component', () => {
  ...
  describe('Keyboard Interactions', () => {
    ...
    beforeEach(() => {
      render(<Slider min={0} max={10} initialValue={initialValue} step={1} />);
      slider = screen.getByRole('slider');
    });

    it('increases value with right arrow key', () => {
      fireEvent.keyDown(slider, { key: 'ArrowRight' });
      expect(slider).toHaveAttribute('aria-valuenow', String(initialValue + 1));
    });
  ...
  describe('Accessibility Features', () => {
    ...
    it('sets aria-valuetext when provided', () => {
      ...
      render(<Slider min={0} max={100} getUserFriendlyValue={getUserFriendlyValue} />);
      const slider = screen.getByRole('slider');
  ...
  it('displays user-friendly value with aria-valuetext', () => {
    ...
    render(<Slider min={0} max={10} getUserFriendlyValue={getUserFriendlyValue} />);
    const slider = screen.getByRole('slider');
