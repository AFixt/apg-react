...
/**
 * Behaviour of the fleet-security secret gate block in .husky/pre-push
 *
 ...
 * It appends because this hook calls npm more than once, and only the first
 * call finds the refs on stdin; overwriting would record the last, empty read.
 */
