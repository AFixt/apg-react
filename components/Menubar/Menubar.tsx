...
const Menubar: React.FC<MenubarProps> = ({ label, menus }) => {
  ...
  useEffect(() => {
    ...
    const onDocClick = (e: MouseEvent) => {
      ...
      const onMenu = Object.values(itemRefs.current).some((el) => el?.contains(e.target as Node));
  ...
  return (
    <div role="menubar" aria-label={label} aria-orientation="horizontal" className="menubar">
      {menus.map((menu, mIdx) => {
